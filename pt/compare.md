...
| **Gemini CLI** | Google | Ferramenta CLI de terminal |
...
| **Gemini CLI** | :x: Nao compativel | - | Sem suporte a roteamento personalizado |
...
| **Gemini CLI** | Impulsionado por Google AI, integracao profunda com o ecossistema Google |
